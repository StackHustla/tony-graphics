        ...
        <div className="row p-5 about-container align-items-center">
          <div className="col-lg-8 mb-1 order-lg-2">
            <h2 className="p-2 justify-content-center text-center">
              Hi I'm Tony, a Senior Graphic Designer and Creative in Huntsville,
              AL.
            </h2>
            <h5 className="p-2 justify-content-center text-center">
              I create brand identities, user interfaces, landing pages,
              websites, social media stories, and everything in-between to make
              brands successful. I also have fun doing so!
            </h5>
            <p className="p-1 justify-content-center text-center">
              I grew up loving to create and customize. Everything to me needed
              ...
              to creating and branding ideas. I always strive to learn more and
              so I am constantly learning new tech stacks to bring forth any and
              every idea I can. I continue to do freelance work for a wide
              variety of clients and, most importantly, learn every day how to
